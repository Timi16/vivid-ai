  ...
  const pools = dark
    ? [
        ...
        },
        {
          ...
          rx: "44%",
          ry: "52%",
          from: "rgba(202,214,240,0.2)",
          mid: "rgba(202,214,240,0.05)",
        },
        {
          cx: "100%",
          cy: "86%",
          rx: "48%",
          ry: "50%",
          from: "rgba(242,235,224,0.16)",
          mid: "rgba(242,235,224,0.04)",
        },
        {
          cx: "50%",
          cy: "100%",
    ...
    : [
        ...
        },
        {
          ...
          rx: "44%",
          ry: "52%",
          from: "rgba(140,158,196,0.16)",
          mid: "rgba(140,158,196,0.04)",
        },
        {
          cx: "100%",
          cy: "86%",
          rx: "48%",
          ry: "50%",
          from: "rgba(186,170,148,0.14)",
          mid: "rgba(186,170,148,0.04)",
        },
        {
          cx: "50%",
          cy: "100%",
