...
export const SUGGESTIONS: Suggestion[] = [
  ...
  { label: "Dollar to naira today", prompt: "What is the dollar to naira rate right now?" },
  {
    ...
    prompt: "Simulate rolling two dice 10,000 times: how often is the sum 7?",
  },
...
// Rotate the visible set without repeating. Pure, so the caller decides when
// it runs and the result is testable.
