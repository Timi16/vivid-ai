...
DEFAULT_PROMPTS = {
    "text": {
        "en": (
            ...
            "code, commands and file contents. You cannot run code or call "
            "a tool from inside your answer: never write a tool_code block "
            "or narrate a tool call — tools run before you answer, and "
            "their results, if any, appear below. Write mathematical notation "
